...
class AdvisorController {
    ...
    public function listAdvisor($request, $response, $args) {
        ...
        if ($id==1){
            ...
            $advisors = array(
                'policy'=>'<pre>SEÇÃO 1 - O QUE FAREMOS COM ESTA INFORMAÇÃO?
                ...
                Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em nononon@gmail.com ou nos enviando uma correspondência em: Shopping na sua Casa Rua Tal 444
                ...
                Se nossa loja for adquirida ou fundida com outra empresa, suas informações podem ser transferidas para os novos proprietários para que possamos continuar a vender produtos para você.</pre>'
            );
        } else{
            $advisors = array();
        }
